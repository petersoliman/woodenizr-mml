...
/**
 * @ORM\Entity
 * @ORM\Table(name="original_design_translations")
 */
class OriginalDesignTranslation extends TranslationEntity implements EditableTranslation
{
     ...
     * @var
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="App\CustomBundle\Entity\OriginalDesign", inversedBy="translations")
     */
