...
/**
 * @ORM\Entity
 * @ORM\Table(name="product_variant_option_translations")
 */
class ProductVariantOptionTranslation extends TranslationEntity implements EditableTranslation
{
    /**
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="App\ProductBundle\Entity\ProductVariantOption", inversedBy="translations")
     */
