 ...
 */
final class Version20241214004811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_guest_data ADD CONSTRAINT FK_E923DECC9F2C3FAB FOREIGN KEY (zone_id) REFERENCES zone (id)');
    }
